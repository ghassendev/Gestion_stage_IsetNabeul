                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="CIN" type="number" class="form-control @error('CIN') is-invalid @enderror" name="CIN" value="{{ old('CIN') }}" required autocomplete="CIN" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="branche" class="col-md-4 col-form-label text-md-right">{{ __('Branche') }}</label>
